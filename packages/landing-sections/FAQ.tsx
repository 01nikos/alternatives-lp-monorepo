  ...
  const getFaqs = () => {
    switch (source) {
      ...
      default:
        return [
          {
            question: "Do I need to replace my current platform?",
            answer: "No! Phleid sits on top of your existing tools. You keep everything you have—your CRM, email platform, Shopify, loyalty programs, reviews, support. Phleid adds the AI intelligence layer that coordinates across everything."
          },
          {
            question: "What's an 'agentic layer'?",
            answer: "An agentic layer is AI that coordinates across your entire marketing stack—like enterprise platforms have built-in. Instead of each tool working in silos, Phleid's AI identifies patterns and opportunities across all your tools to maximize revenue."
          },
          {
            question: "How does pricing work?",
            answer: "Flat-rate pricing from $999-$1,500/month based on your company size. No surprises, no scaling fees as you grow."
          },
          {
            question: "How long until I see results?",
            answer: "Your Stack Intelligence Report is delivered in 48 hours. This identifies underused features and revenue opportunities across your entire stack. Weekly strategic briefs start immediately after onboarding."
          ...
          {
            question: "What if I'm not ready to commit?",
            answer: "Start with the free Stack Intelligence Report. We'll analyze your stack and show you exactly what opportunities you're missing—no commitment required."
          }
        ];
    }
  };
