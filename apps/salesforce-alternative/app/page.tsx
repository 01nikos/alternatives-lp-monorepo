...
export default function SalesforceAlternativePage() {
  ...
  const structuredData = {
    ...
    "description": "AI-powered agentic layer for marketing stacks. Coordinates across Salesforce, Shopify, and other tools to provide enterprise-level intelligence.",
    "offers": {
      "@type": "Offer",
      "price": "999",
      "priceCurrency": "USD",
    ...
    "operatingSystem": "Web",
    "url": "https://salesforcealternatives.com"
  };
  ...
  const faqStructuredData = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do I need to replace Salesforce?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No! Phleid sits on top of Salesforce. You keep all your existing tools—Salesforce, Shopify, loyalty programs, reviews, support. Phleid adds the AI intelligence layer that coordinates across everything."
        }
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 via-indigo-50 to-cyan-50">
      <Hero
        headline="Searching for Salesforce Alternatives? There's a Better Option."
        subheadline="Don't replace Salesforce. Add AI intelligence on top. Keep your tools, gain enterprise-level agentic marketing for $999/month."
        primaryCTA={{
      ...
      <PainPoints
        ...
        points={[
          ...
          },
          {
            ...
            description:
              "Salesforce can't coordinate with your loyalty, reviews, support, and Shopify data.",
          },
          {
            icon: "TrendingDown",
      ...
      <ComparisonTable headline="Your Three Options" competitor="salesforce" />

      <FAQ source="salesforce" />

      <div id="lead-form">
        <LeadCaptureForm
          headline="Don't Replace Your Stack. Upgrade It With AI."
          subheadline="See what enterprise-level agentic marketing can do for your Salesforce stack"
          source="salesforce"
          placement="footer"
